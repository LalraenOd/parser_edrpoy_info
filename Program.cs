    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                File.AppendAllText("debugInfo.txt", "EDRPOU count: " + listEdrpou.Count + ".\n Time Elapsed: " + elapsedTime.ToString() + "\n");
                Console.WriteLine("Press any key to exit...");
                Console.ReadKey();
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.ToString(), Console.BackgroundColor = ConsoleColor.Red);
                Console.WriteLine("Exception occured. Please, contact the developer.");
                File.AppendAllText("debugInfo.txt", ex.ToString());
                Console.ReadKey();
                throw;
            }
        }
